#Práctica 2: Text Normalization
#Autor: Braulio Hernandez Minutti 
#Procesamiento de Lenguaje Natural ESCOM IPN
...
with open('corpus_noticias_procesado.txt', 'w', encoding='utf-8') as file:
